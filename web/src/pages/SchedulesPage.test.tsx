...
describe("SchedulesPage", () => {
    ...
    vi.stubGlobal(
      ...
      vi.fn(async (input: RequestInfo | URL, init?: RequestInit) => {
        ...
        if (path === "/api/v1/admin/schedules" && method === "POST") {
          return jsonResponse({ ...existingSchedule, id: "22222222-2222-4222-8222-222222222222", ...body }, { status: 201 });
        }
  ...
  it("creates and ticks scheduled tasks", async () => {
    ...
    await user.type(screen.getByLabelText("执行时间"), "2026-08-13T09:00");
    ...
    expect(window.confirm).toHaveBeenCalledWith("Delete scheduled task daily-report?");
    await waitFor(() => {
      expect(requests).toContainEqual({
        path: "/api/v1/admin/schedules/11111111-1111-4111-8111-111111111111",
        method: "DELETE",
