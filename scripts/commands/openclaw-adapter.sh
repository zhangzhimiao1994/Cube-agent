...
Optional environment:
  ...
  OPENCLAW_ADAPTER_DESKTOP_ACTION_COMMAND_JSON Fixed non-shell argv array used for desktop_action without operation argv; receives operation JSON on stdin.
EOF
}
